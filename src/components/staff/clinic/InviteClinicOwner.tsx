...
import { inviteClinicOwner } from '@/components/api/clinic';
...
const InviteClinicOwner: React.FC = () => {
    ...
    const clinicOwnerMutation = useMutation({
        mutationFn: inviteClinicOwner,
        onSuccess: () => {
            navigate('/staff/dashboard', {
                state: {
                    snackbar: {
                        message: t('clinic.clinicOwner.createSuccess'),
                        severity: 'success',
                    }
                }
            });
...
export default InviteClinicOwner;